...
export default function ParkinsonDetector() {
  ...
  const handleSampleClick = (type: 'healthy' | 'pd') => {
    ...
    setUsingSample(type);
    setSampleImageUrl(type === 'healthy' 
      ? "/lovable-uploads/c8192bfd-98bf-4de6-a382-b32e625a39ae.png" 
      : "/lovable-uploads/9ec3acac-2027-4656-90d7-ce358c251987.png");
    setShowResults(false);
  };
        ...
        if (newProgress >= 100) {
          ...
          setTimeout(() => {
            ...
            if (usingSample === 'healthy') {
              ...
              if (!isValidFilename || !isPngFile) {
                setDiagnosisResult('error');
              } else {
                // For valid files, randomly determine if PD or healthy
              ...
              <div className="glass-card rounded-2xl overflow-hidden subtle-shadow sticky top-8">
                ...
                <div className="p-5">
                  <UploadZone
                    ...
                    maxSizeMB={5}
                    className="mb-6"
                    preselectedImage={sampleImageUrl}
                  />
